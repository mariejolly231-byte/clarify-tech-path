...
export function History() {
  return (
    <Section id="histoire" num="04" eyebrow="Partie 1 · D'où ça vient — où on en est" title="40 ans de sentiers tracés">
      ...
      <div className="mt-14">
        <div className="text-[11px] uppercase tracking-[0.2em] text-primary">Cas exemple</div>
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-4">
          {INVOICE_STEPS.map((step, i) => (
            ...
            >
              ...
              <p className="mt-2 text-sm leading-relaxed text-foreground/85">{step.what}</p>
