...
const CATEGORIES: Cat[] = [
  {
    ...
    tools: [
      { name: "Notion", slug: "notion", usage: "Docs + base de données + wiki + tâches", price: "Gratuit · Plus 10 $/mois · Notion AI +10 $/mois", multi: true },
      { name: "Airtable", slug: "airtable", usage: "Base de données structurée avec vues multiples", price: "Gratuit (1 000 lignes) · Team 20 $/mois/utilisateur", multi: true },
      { name: "Google Sheets", slug: "googlesheets", usage: "Tableur collaboratif, point d'entrée universel", price: "Gratuit (inclus Google Workspace)", multi: true },
    ],
  },
  {
    ...
    tools: [
      { name: "Make (ex-Integromat)", slug: "make", usage: "Automatisation visuelle multi-étapes, très puissant — 2 à 4× moins cher que Zapier", price: "Gratuit (1 000 opérations/mois) · Core 9 $/mois" },
      { name: "n8n", slug: "n8n", usage: "Alternative open-source, plus technique, contrôle total", price: "Gratuit en auto-hébergé · Cloud dès 20 $/mois" },
      { name: "Zapier", slug: "zapier", usage: "Le plus simple, le plus connu", price: "Gratuit (100 tâches/mois) · Starter 19,99 $/mois" },
  ...
  },
  {
    ...
    tools: [
      { name: "Bubble", slug: "bubble", usage: "App web complexe sans coder", price: "Gratuit limité · Starter 29 $/mois" },
      ...
      { name: "Webflow", slug: "webflow", usage: "Sites vitrines professionnels", price: "Gratuit · Basic 14 $/mois" },
  ...
  },
  {
    ...
    tools: [
      { name: "Notion CRM", slug: "notion", usage: "CRM simple intégré à l'espace de travail", price: "Inclus dans Notion (dès 10 $/mois)", multi: true },
      { name: "Airtable CRM", slug: "airtable", usage: "CRM sur-mesure avec automatisations", price: "Inclus dans Airtable Team (20 $/mois/utilisateur)", multi: true },
      { name: "HubSpot Free", slug: "hubspot", usage: "CRM complet avec pipeline commercial", price: "Gratuit (fonctions de base très solides)" },
      { name: "Brevo", slug: "brevo", usage: "CRM + email marketing + SMS", price: "Gratuit jusqu'à 300 emails/jour · Starter 7 €/mois" },
    ],
  },
  {
    ...
    tools: [
      { name: "ChatGPT (OpenAI)", slug: "openai", usage: "Assistant IA, rédaction, analyse", price: "Gratuit · Plus 20 $/mois · Business 30 $/mois/siège", deal: "Freelance Stack : 1 siège Business offert 2 ans" },
      { name: "Claude (Anthropic)", slug: "anthropic", usage: "Rédaction longue, analyse de documents, rigueur", price: "Gratuit · Pro 20 $/mois" },
      { name: "Perplexity", slug: "perplexity", usage: "Recherche augmentée par IA avec sources citées", price: "Gratuit · Pro 20 $/mois" },
      { name: "Make + IA", slug: "make", usage: "Automatisation avec intelligence dans la boucle", price: "Inclus dans Make + coût API IA à l'usage", multi: true },
      { name: "Notion AI", slug: "notion", usage: "Résumer, rédiger, traduire depuis ses propres docs", price: "+10 $/mois/utilisateur en supplément de Notion", multi: true },
    ],
  },
];
...
export function ToolsMap() {
  return (
    ...
    >
      ...
      {/* À retenir */}
      <div className="mt-12 rounded-2xl border-2 border-primary/30 bg-primary/[0.05] p-7 shadow-sm">
        <div className="text-[11px] uppercase tracking-[0.2em] text-primary">À retenir</div>
        <p className="mt-3 text-[15px] leading-relaxed text-foreground/90">
          Les outils convergent. Notion intègre de l'IA. Airtable intègre de l'automatisation.
          Make intègre de l'IA. La frontière entre catégories s'efface — c'est votre usage qui compte.
        </p>
      </div>
    </Section>
  );
